...
if uploaded_file:
    # Read batter vs pitcher file (tab-delimited)
    ...
    st.dataframe(filtered_df[['Batter', 'Tm', 'vs', 'HR', 'HR_Predict_Score', 'Salary', 'Position']].sort_values(by='HR_Predict_Score', ascending=False), use_container_width=True)
    ...
    # Get best lineup by HR_Predict_Score under salary cap
    best_score = 0
